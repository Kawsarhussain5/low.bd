...
const Footer = () => {
    return (
        <footer className="footer footer-horizontal footer-center bg-black text-white text-base-content  p-20 mt-14">
            <div className='flex'><img src={logofooterImg} alt="" /><span className='text-3xl font-extrabold'>Law.BD</span></div>
  <nav className="grid grid-flow-col gap-4">
  <ul className="menu menu-horizontal px-1 text-xl font-medium flex gap-8">
  ...
  <nav>
    <div className="grid grid-flow-col gap-4">
      ...
      <a href='https://www.facebook.com/kawsar.mahmud.572456/' target='_blank'>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
